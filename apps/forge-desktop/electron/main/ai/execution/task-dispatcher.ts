import type { IExecutionTask, IExecutionContext } from './execution-types';
...
export class TaskDispatcher {
  constructor(
    ...
    private readonly policyRegistry: ExecutionPolicyRegistry,
    private readonly workspaceService: IWorkspaceService,
    private readonly logger: IDesktopLogger
  ) {}

  async dispatch(task: IExecutionTask, abortSignal: AbortSignal, executionId: string): Promise<any> {
