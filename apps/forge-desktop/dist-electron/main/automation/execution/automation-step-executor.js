...
exports.AutomationStepExecutor = void 0;
const automation_artifact_store_1 = require("../artifacts/automation-artifact-store");
class AutomationStepExecutor {
    actionExecutor;
    agentOrchestrator;
    artifactStore;
    constructor(actionExecutor, agentOrchestrator, artifactStore = new automation_artifact_store_1.AutomationArtifactStore()) {
     ...
     */
    async executeStep(step, jobId, execution) {
        ...
        try {
            ...
            if (step.outputArtifact && stepData) {
                ...
                const art = await this.artifactStore.saveArtifact(execution.workspaceRoot, execution.id, step.id, step.outputArtifact, content);
...
exports.AutomationStepExecutor = AutomationStepExecutor;
//# sourceMappingURL=automation-step-executor.js.map