...
export type AutomationTimelineEventType = 'automation.pipeline.queued' | 'automation.pipeline.started' | 'automation.pipeline.step_started' | 'automation.pipeline.step_finished' | 'automation.pipeline.completed' | 'automation.pipeline.failed' | 'automation.pipeline.cancelled';
