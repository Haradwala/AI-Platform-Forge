...
export type IntelligenceEventType = 'intelligence.indexing.started' | 'intelligence.indexing.progress' | 'intelligence.indexing.completed' | 'intelligence.indexing.failed' | 'intelligence.analysis.impact_calculated' | 'intelligence.analysis.dead_code_detected' | 'intelligence.context.assembled';
