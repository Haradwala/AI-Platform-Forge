...
export type ContainerEvent = 'service.registered' | 'service.resolved' | 'service.initialized' | 'service.disposed' | 'service.failed' | 'module.loaded' | 'module.skipped' | 'plugin.loaded' | 'validation.started' | 'validation.completed' | 'container.frozen' | 'container.disposed';
