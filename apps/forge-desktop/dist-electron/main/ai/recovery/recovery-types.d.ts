...
export type RecoveryState = 'idle' | 'detecting' | 'analyzing' | 'planning' | 'waitingApproval' | 'recovering' | 'retrying' | 'rollingBack' | 'replanning' | 'reexecuting' | 'verifying' | 'recovered' | 'failed' | 'escalated' | 'cancelled';
...
export interface IRecoveryStrategy {
    ...
    execute(workspaceRoot: string | null): Promise<{
        success: boolean;
        message: string;
    }>;
}
