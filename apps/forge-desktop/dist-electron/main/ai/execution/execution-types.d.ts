...
export type ExecutionState = 'pending' | 'queued' | 'waiting' | 'running' | 'paused' | 'retrying' | 'rollingback' | 'completed' | 'cancelled' | 'failed';
export type TaskPriority = 'critical' | 'high' | 'normal' | 'low' | 'idle';
export type ExecutionPolicy = 'simulation' | 'dry-run' | 'safe' | 'interactive' | 'auto' | 'dangerous' | 'readonly' | 'workspace-only';
